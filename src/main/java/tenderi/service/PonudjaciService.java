...
public class PonudjaciService {
    ...
    public Optional<Ponudjaci> partialUpdate(Ponudjaci ponudjaci) {
        ...
        return ponudjaciRepository
            ...
            .map(
                existingPonudjaci -> {
                    if (ponudjaci.getSifraPostupka() != null) {
                        existingPonudjaci.setSifraPostupka(ponudjaci.getSifraPostupka());
                    }
                    if (ponudjaci.getSifraPonude() != null) {
                        existingPonudjaci.setSifraPonude(ponudjaci.getSifraPonude());
                    }
