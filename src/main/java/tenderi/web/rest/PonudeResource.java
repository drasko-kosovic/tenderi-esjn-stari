...
import tenderi.service.PonudeQueryService;
import tenderi.service.PonudeService;
import tenderi.service.criteria.PonudeCriteria;
import tenderi.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link tenderi.domain.Ponude}.
 */
@RestController
@RequestMapping("/api")
public class PonudeResource {
     ...
     */
    @GetMapping("/ponudes")
    public ResponseEntity<List<Ponude>> getAllPonudes(PonudeCriteria criteria, Pageable pageable) {
